...
Contribution to TableauExcerptExtension is encouraged: bug reports, discussions,
...
TableauExcerptExtension is governed under the
...
TableauExcerptExtension contributions must be well understood by the submitter
...
> I developed TableauExcerptExtension using [Kiro][kiro] in both "vibe" and
> "spec" modes using various Claude models. Before releasing, I performed a
> _thorough_ review and rewrite of substantial sections of the code as the model
...
Austin Ziegler created TableauExcerptExtension.
